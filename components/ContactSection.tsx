...
const ContactSection: React.FC = () => {
    ...
    return (
        <div className="w-full bg-zinc-900 border border-zinc-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
            {/* Left Column: Contact Info */}
            <div className="w-full md:w-5/12 bg-zinc-950 p-8 md:p-12 flex flex-col justify-center relative overflow-hidden">
                ...
                <p className="text-zinc-400 mb-12 leading-relaxed">
                    Feel free to contact me for any work, internships, or collaboration opportunities.
                </p>
            ...
            {/* Right Column: Form */}
            <div className="w-full md:w-7/12 bg-zinc-900/50 p-8 md:p-12">
                {isSent ? (
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-zinc-950/50 border border-zinc-700/50 rounded-xl px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 transition-all"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full bg-zinc-950/50 border border-zinc-700/50 rounded-xl px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 transition-all resize-none"
                            />
                        </div>
